...
public class Controller {
	...
	public static void main(String[] args) throws Exception {
		...
		String crawlStorageFolder = "/home/andrey";
        int numberOfCrawlers = 3;

        CrawlConfig config = new CrawlConfig();
        config.setCrawlStorageFolder(crawlStorageFolder);
        config.setResumableCrawling(true);
        config.setUserAgentString("Westmont IR Dillon Montag: Team Montag-Kitsen");
        ...
        //System.out.println("The top most common words: ");
        //MyCrawler.frequencies();
        //System.out.println("The top most common two grams: ");
        //MyCrawler.twoGramCounter();
        MyCrawler.palindromes();
